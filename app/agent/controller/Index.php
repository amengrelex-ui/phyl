...
use app\common\service\AgentAdmin as S;

class Index extends Base
{
    protected $middleware = ['AgentCheck'];
    
    // 首页
    public function index(){
        return $this->fetch('',[
            'nickname'  => get_field('agent_admin',Session::get('agent.id'),'nickname')
        ]);
    }
    ...
    public function menu(){
        return json(get_tree(Session::get('agent.menu')));
    }
