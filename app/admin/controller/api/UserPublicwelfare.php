...
use app\common\service\ApiUserPublicwelfare as S;
use app\common\model\ApiUserPublicwelfare as M;

class UserPublicwelfare extends  \app\admin\controller\Base
{
