...
use app\common\service\ApiSubscribe as S;
use app\common\model\ApiSubscribe as M;
use think\facade\Db;

class Subscribe extends  \app\admin\controller\Base
{
    ...
    public function edit($id){
        ...
        $model = M::find($id);
        $uid = $model['user_id'];
        $account = Db::name('api_account')->where('user_id',$uid)->where('type',$model['month_type'])->find();
